...
## 기능 요구 사항
- 상세보기 메뉴 추가
  게시물 상세보기 화면에서는 다양한 작업을 할 수 있어야 합니다. 게시물의 수정과 삭제를 선택할 수 있어야 하며, 댓글을 달거나 좋아요/싫어요를 선택할 수 있는 등 많은 것을 할 수 있습니다. 먼저 상세보기화면에 들어왔을 때 실행할 수 있는 기능들을 메뉴화 해주세요.
...
상세보기 기능을 선택해주세요(1. 댓글 등록, 2. 좋아요, 3. 수정, 4. 삭제, 5. 목록으로) : 1
[댓글 기능]
상세보기 기능을 선택해주세요(1. 댓글 등록, 2. 좋아요, 3. 수정, 4. 삭제, 5. 목록으로) : 5
명령어를 입력해주세요 :
```
