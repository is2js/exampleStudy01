...
- 정렬기능(sort명령어, 기준무시하고 일단 1개 변수로 + 오름차순 정렬시키기)
- 
## 요구사항 - 정렬 기능
- 정렬 기능 추가
   - 명령어 :sort
   - 정렬은 정렬 대상과 정렬 방법대로 정렬되어야 함.
      - 정렬 대상 : 번호, 조회수
         - 입력 예시) 정렬 대상을 선택해주세요. (1. 번호,  2. 조회수)
      - 정렬 방법 : 오름차순, 내림차순
         - 입력 예시) 정렬 방법을 선택해주세요. (1. 오름차순,  2. 내림차순)
   - 힌트 : Collections.sort, Comparator
...
명령어를 입력해주세요 :
sort
정렬 대상을 선택해주세요. (1. 번호,  2. 조회수) : 2
정렬 방법을 선택해주세요. (1. 오름차순,  2. 내림차순) : 2
